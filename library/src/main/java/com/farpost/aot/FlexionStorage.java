...
/**
 * Этот класс не простое хранилище, но объединяющее звено для всех остальных хранилищ,
 * поэтому эвристика его метода get немного отличается от остальных хранилищ, и возвращает не служебную информацию,
 * а напрямую искомый результат.
...
public class FlexionStorage {
	 ...
	 * Принимает строку, и если она является словоформой неких исзвестных нам лемм,
