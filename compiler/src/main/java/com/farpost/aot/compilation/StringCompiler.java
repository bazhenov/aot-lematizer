...
public class StringCompiler implements Closeable {
	...
	private final DataOutputStream file = new DataOutputStream(new FileOutputStream(
		"aot-lematizer/src/main/resources/STRINGS.BIN"
	));
	...
	StringCompiler() throws FileNotFoundException {
	...
	void OnString(String str) throws IOException {
